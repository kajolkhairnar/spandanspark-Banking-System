...
<?php
    include 'config.php';
    $sql = "SELECT * FROM `money_transaction`";
...
<div class="container">
    <div class="bold"><h2 class="text-center pt-4 ">Transfer Money</h2></div>
        <br>
            <div class="row">
                <div class="col">
                    <div class="table-responsive-sm">
                    <table class="table" class="table table-hover table-sm table-striped table-condensed table-bordered">
                        <thead>
                            <tr>
